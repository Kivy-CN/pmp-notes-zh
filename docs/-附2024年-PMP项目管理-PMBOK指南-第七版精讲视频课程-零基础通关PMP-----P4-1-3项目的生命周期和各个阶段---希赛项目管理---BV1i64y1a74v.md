# （附2024年）PMP项目管理《PMBOK指南》第七版精讲视频课程（零基础通关PMP）！ - P4：1.3项目的生命周期和各个阶段 - 希赛项目管理 - BV1i64y1a74v

大家好，接下来我们花一点时间来跟大家分享，项目的生命周期和阶段的概念啊，其实每一个项目他都有自己的项目生命周期，包括说每一个产品也有它自己的生命周期，以及包括我们人类也有自己的生命周期对吧。
...
中间可能会有半年到一年左右的时间会去跑空，那那个跑空它就是一个试运行的过程对吧，试运行后呢就会有一个验收验收，也有一些领域呢会叫做里程碑的审查，验收验收通过以后，自己内部会去总结一些经验和教训。
